...
const LINKS = [
  {
    ...
    note: "The best way. I reply within a day or two.",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    ...
    note: "Introductions, referrals, and networking.",
  },
  {
    icon: GitBranch,
    label: "GitHub",
  ...
  },
  {
    ...
    note: "One page. Kept current for the 2027 cycle.",
  },
];
    ...
    <PageTransition>
      <div className="mx-auto max-w-[1200px] px-6 pt-28 pb-24">
        ...
        >
          ...
          <p
            className="max-w-2xl text-[19px] leading-[1.6]"
            style={{ color: "var(--text-2)" }}
          >
            I'm open to Spring, Summer, and Fall internships or co-ops in
            software engineering and adjacent areas, whether that's AI/ML,
            cloud, data, or infrastructure. If you're building something
          ...
          <motion.div {...rise}>
            ...
            <div className="mt-16 max-w-md">
              ...
              >
                ...
                love to hear about it.&rdquo;
              </p>
              <p
                className="mt-4 text-[12.5px]"
                style={{ color: "var(--text-3)" }}
              >
                Ameer, New York Metro Area
              </p>
            </div>
          </motion.div>
